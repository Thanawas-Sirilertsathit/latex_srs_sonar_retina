...
For instance, \textit{Spatial Sound Ball} \cite{SpatialSoundBall} provides high-quality visualization but lacks the analytical AI to identify sound types and directions. 
...
According to the systematic review by \cite{Liaquat2021}, Sound Source Localization (SSL) is a mature field but faces unique challenges when applied to ad-hoc microphone arrays such as those found in consumer mobile devices. 
