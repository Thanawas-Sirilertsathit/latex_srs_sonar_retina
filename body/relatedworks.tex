...
\begin{tabular}{ccc}
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{assets/apps/spatial-sound-ball.png}
        \caption{Spatial Sound Ball}
    \end{subfigure} &
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{assets/apps/sound-log.png}
        \caption{Sound Log}
    \end{subfigure} &
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{assets/apps/sound-meter.png}
        \caption{Sound Meter}
    \end{subfigure}
\end{tabular}
\caption{Interface comparison of existing acoustic assistive applications.}
\end{figure}
