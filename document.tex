...
\def \srsTitle{Sonar Retina}
\def \srsAuthorOne{Thanawas Sirilertsathit}
\def \srsAuthorTwo{Pattharamon Dumrongkittikule}
\def \srsAuthorThree{} % Define as empty to avoid undefined control sequence errors
\def \srsAcademicYear{2026}

\def \srsAdvisorName{Assoc. Prof. Dr. Kitsana Waiyamai}
\def \srsCoAdvisorName{} % Define as empty to avoid undefined control sequence errors
